...
fname='scatter_FA_data_dividedbymandFonlyzoladist.mat'
...
individual_hit_data_L28=info_barplot['combinedmatindividualL28']

combinedmatSDindividual=(info_barplot['combinedmatSDindividual'])
combinedmatSDindividuall28=info_barplot['combinedmatSDindividualL28']
...
intertrialcontrol_individual=np.concatenate((individual_hit_data_L28[:,2], individual_hit_data_L28[:,3]))
...
plt.ylim([0,1])
plt.savefig(bin_folder + '\proportionofFArejectionsoverdisttypezola.png', dpi=500,
            bbox_inches='tight')
plt.show()
...
plt.savefig(bin_folder + '\FArejectionsoverdisttypezolaMtalker.png', dpi=500,
            bbox_inches='tight')
plt.show()
