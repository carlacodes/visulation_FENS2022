...
ax=plt.errorbar([0,1,2,3], info_barplot['combinedmat'][0], yerr=info_barplot['combinedmatSD'][0],fmt="o", elinewidth=2, ms=5, color='darkorange', label='Intra-trial Roved F0')
...
ax=plt.errorbar([0.1,1.1,2.1,3.1], info_barplot['combinedmat'][1], yerr=info_barplot['combinedmatSD'][1],fmt="o", elinewidth=2, ms=5, color='bisque', label='Control F0')
...
ax=plt.errorbar([0.3,1.3,2.3,3.3], info_barplot['combinedmat'][2], yerr=info_barplot['combinedmatSD'][2],fmt="o", elinewidth=2, ms=5, color='blueviolet', label='Inter-trial Roved F0')
...
ax=plt.errorbar([0.4,1.4,2.4,3.4], info_barplot['combinedmat'][3], yerr=info_barplot['combinedmatSD'][3],fmt="o", elinewidth=2, ms=5, color='plum', label='Control F0')
...
plt.ylabel('P of False Alarms', fontsize=15)
plt.title('Proportion of False Alarms for \n Intra and Inter-trial F0 Roving', fontsize=20)
plt.savefig(bin_folder + '\seaborn_scatter_FA120522.png', dpi=500, bbox_inches='tight')
