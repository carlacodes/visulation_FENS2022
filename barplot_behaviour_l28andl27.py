...
bin_folder='D:/Data/Results/L27general'
fname='pitch_curve_data_L27.mat'
...
colors = ['cadetblue' if c >= 4 else 'powderblue' for c in info_barplot_df["Pitch"]]
...
ax.set_ylabel('P. of Hits and False Alarms  ', fontsize=15)
