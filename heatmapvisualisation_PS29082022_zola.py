...
fname='confusion_matrix_zola_PS.mat'
info_heatmap = rd.loadmat(bin_folder + os.sep + fname)
fname_raw='confusion_matrix_zola_PS_raw.mat'
...
for i in range(0, len(heatmap_bychan)):
    ...
    plt.savefig(bin_folder + '\seabornheatmap_29082022_chan'+np.array2string(channel_list[i])+'.png', dpi=500, bbox_inches='tight')
